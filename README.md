...
Themes are converted from the [VS Code source repository](https://github.com/microsoft/vscode) (default: `1.119.0`, configurable via `VSCODE_REF`) using an automated pipeline:
