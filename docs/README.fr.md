...
Les thèmes sont convertis depuis le [dépôt source de VS Code](https://github.com/microsoft/vscode) (par défaut : `1.119.0`, configurable via `VSCODE_REF`) via un pipeline automatisé :
